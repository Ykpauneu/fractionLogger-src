...
local scriptVersion = "v0.4.2-beta"
local scriptChangeLog = [[
Fraction Logger - v0.4.2-beta
...
function sampev.onShowDialog(id, style, title, button1, button2, text)
    if id == 22 and title == "Статистика персонажа" and needToLogin then
        ...
        if playerData.fraction:find("Army SF") or playerData.fraction:find("FBI") or playerData.fraction:find("Army LV") or playerData.fraction:find("Mayor") or playerData.fraction:find("Medic") then
